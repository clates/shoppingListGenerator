...
export default function Recipe() {
  ...
  return (
    <div>
        ...
        <div className="grow">
          ...
          <div className="flex flex-row items-center ml-4 mb-2">
            ...
            <span
              ...
              className="block h-5 w-5 bg-cover ml-3 mr-1"
            />
      ...
      {JSON.parse(recipeInformation).map((section) => (
        <div>
          <div className="text-xl ml-4 text-purple-500 mt-2">
            {section.sectionName}
          </div>
          ...
          <div>
            {section.ingredients.map((ingredient) => (
              <div className="flex flex-row">
                <div className="w-24 text-right mr-2">{ingredient.qty}</div>{" "}
                <span class="text-purple-500">|</span>{" "}
                <div className="ml-2">{ingredient.name}</div>
              </div>
            ))}
          </div>
        </div>
